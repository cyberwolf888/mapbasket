...
@section('content')
    ...
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item" href="{{ route('master.club.manage') }}">Club</span>
    ...
    <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
            <a href="{{ route('master.club.prestasi.create', ['id'=>$club->id]) }}" class="btn btn-teal btn-with-icon">
                <div class="ht-40">
                ...
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    @foreach ($model as $item)
                        <tr>
                            ...
                            <td>{{ $item->prestasi }}</td>
                            <td>
                                <a href="{{ route('master.club.prestasi.delete', ['id' => $item->id]) }}" class="btn btn-danger btn-icon"><div><i class="fa fa-trash"></i></div></a>
                            </td>
							<?php $no++; ?>
                        </tr>
                    @endforeach
