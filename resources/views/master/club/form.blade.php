...
@section('content')
    ...
    <div class="br-pagetitle">
        ...
        <div>
        <h4>Club</h4>
        <p class="mg-b-0">Create data club.</p>
        </div>
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
            ...
            <div class="br-section-wrapper">
                    ...
                    {!! Form::open(['route' => isset($update) ? ['master.club.update', $model->id] :'master.club.store', 'method' => 'post']) !!}
                    <div class="form-layout form-layout-1">
                      <div class="row mg-b-25">
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                {!! Form::email('email', isset($update) ? $model->user->email : null,['id'=>'email','class'=>'form-control','required'=>'']) !!}
                            </div>
                        </div><!-- col-4 -->
                        <div class="col-lg-4">
                            <div class="form-group">
                      ...
                      <div class="form-layout-footer">
                        ...
                        <a class="btn btn-secondary" href="{{ route('master.club.manage') }}">Cancel</a>
