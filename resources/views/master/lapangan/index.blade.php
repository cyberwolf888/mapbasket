...
@section('content')
    ...
    <div class="br-pagebody">
        ...
        <div class="br-section-wrapper">
            <a href="{{ route('master.lapangan.create') }}" class="btn btn-teal btn-with-icon">
              <div class="ht-40">
                            ...
                            <tbody>
                              ...
                              @foreach ($model as $item)
                                <tr>
                                  ...
                                  <td>{{ $item->alamat }}</td>
                                  <td>
                                      <a href="{{ route('master.lapangan.foto.manage',['id' => $item->id]) }}" class="btn btn-info btn-icon"><div><i class="fa fa-image"></i></div></a>
                                      <a href="{{ route('master.lapangan.edit', ['id' => $item->id]) }}" class="btn btn-warning btn-icon"><div><i class="fa fa-pencil"></i></div></a>
                                      <a href="{{ route('master.lapangan.show', ['id'=>$item->id]) }}" class="btn btn-green btn-purple"><div><i class="fa fa-eye"></i></div></a>
                                  </td>
                                  <?php $no++; ?>
                                </tr>
                              @endforeach
