...
@section('content')
    ...
    <div class="br-pagetitle">
        ...
        <div>
        <h4>Lapangan</h4>
        <p class="mg-b-0">Create foto lapangan.</p>
        </div>
    </div><!-- d-flex -->
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
                ...
                {!! Form::open(['route' => ['master.lapangan.foto.store', $lapangan->id], 'method' => 'post', 'files'=>true]) !!}
                <div class="form-layout form-layout-1">
                    ...
                    <a class="btn btn-secondary" href="{{ route('master.lapangan.foto.manage', ['id'=>$lapangan->id]) }}">Cancel</a>
