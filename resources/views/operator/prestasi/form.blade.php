...
@section('content')
    <div class="br-pageheader">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            <a class="breadcrumb-item" href="{{ route('master.dashboard') }}">Operator</a>
    ...
    <div class="br-pagebody">
        <div class="br-section-wrapper">
            ...
            {!! Form::open(['route' => ['operator.prestasi.store'], 'method' => 'post', 'files'=>true]) !!}
            <div class="form-layout form-layout-1">
                ...
                <div class="form-layout-footer">
                    ...
                    <a class="btn btn-secondary" href="{{ route('operator.prestasi.manage') }}">Cancel</a>
